...
// }
//se for en-CA , usar o comando const str2 = str.substring(0, str.length - 3); para tirar os ultimos 3 caracteres, criar um if para verificar o tamanho do navigator.language para realizar essa ação. lenght
