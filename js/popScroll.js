...
function encaminharSite(){   window.location.replace('/pt-BR/decline_popup.html');}
function encaminharSiteEn(){  window.location.replace('/en/decline_popup.html');}
function encaminharSiteEs(){  window.location.replace('/es/decline_popup.html');}
